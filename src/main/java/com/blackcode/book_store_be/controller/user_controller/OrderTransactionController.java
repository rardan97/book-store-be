...
public class OrderTransactionController {
    ...
    public String createTransactionToken(@RequestBody TransaksiPembelianRequest transaksiPembelianRequest) {
        try {
            ...
            Map<String, Object> data = midtransService.createTransactionToken(transaksiPembelianRequest);
            return new JSONObject().put("data", data).toString();
        } catch (Exception e) {
            e.printStackTrace();
            return new JSONObject().put("error", "Failed to create transaction token").toString();
        }
    }
